#+property: header-args:prolog :comments both :mkdirp yes :padline yes :tangle tangled/codigos.pl
...
- El reticulo es: [[file:imgs/reticext2.png]]
...
| [[file:imgs/finito2.png]]      | [[file:imgs/chain2.png]]          |
| finito en profundidad |                          |
| [[file:imgs/finitedepht2.png]] |                          |
...
- Entrada
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/app.pl
...
- Entrada
  #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/analisis/qsort.pl
...
- Entrada
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/debugging/qsort1.pl
...
- Entrada
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/qsort2.pl
...
- Chequear Aserciones
    ...
    #+BEGIN_SRC prolog :tangle tangled/debugging/qsort3.pl
...
- Entrada
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/optimizacion/dup.pl
...
- Salida 
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/optimizacion/dup_out.pl
...
- Entrada
    ...
    #+BEGIN_SRC prolog optimizacion/append.pl
...
- Salida 
    #+REVEAL_HTML: <div style="font-size: 110%;">
    #+BEGIN_SRC prolog :tangle tangled/optimizacion/append_out.pl
...
- Entrada
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/optimizacion/exponential_ac.pl
...
- Salida 
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/optimizacion/exponential_ac_out.pl
...
- Entrada
    #+REVEAL_HTML: <div style="font-size: 130%;">
    #+BEGIN_SRC prolog :tangle tangled/certificacion/multiply.pl
